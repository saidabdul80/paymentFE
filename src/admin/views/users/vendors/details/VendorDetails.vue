<template>
    <div class="rounded-lg tw-p-0 tw-border">
        ...
        <div class="text-center">
            ...
            <v-btn v-if="!vendorStore?.isEditing" type="submit" variant="outlined" prepend-icon="mdi-pencil"
                :color="$constants.primary" :class="`tw-bg-${$constants.primary}-900 tw-mr-2 text-capitalize`"
        ...
        <div class="tw-text-lg" v-if="vendorStore.currentVendor">
            <v-card-text>
                <v-list-item>
                    <div v-if="!vendorStore.vendorsLoading">
                        <div v-if="!vendorStore.isEditing" class="tw-flex">
                            <div :class="`tw-text-[${$constants.primary}]`" class="tw-pr-2"><strong>G-TIN: </strong>
                            </div>
                            <div :class="`tw-text-[${$constants.dark}]`" class="">{{ vendorStore.currentVendor?.g_tin }}
                            </div>
                        </div>
                        <text-field label="G-TIN" v-else v-model="vendorStore.currentVendor.g_tin"></text-field>
                    </div>
                    <span v-else><v-skeleton-loader :loading="vendorStore.vendorsLoading" type="text" /></span>
                </v-list-item>
                <v-list-item>
                    <div v-if="!vendorStore.vendorsLoading">
                        <div v-if="!vendorStore.isEditing" class="tw-flex">
                            <div :class="`tw-text-[${$constants.primary}]`" class="tw-pr-2"><strong>NIN: </strong></div>
                            <div :class="`tw-text-[${$constants.dark}]`" class="">{{ vendorStore.currentVendor?.nin }}
                            </div>
                        </div>
                ...
                <v-list-item>
                    <div v-if="!vendorStore.vendorsLoading">
                        <div v-if="!vendorStore.isEditing" class="tw-flex">
                            ...
                            <div :class="`tw-text-[${$constants.dark}]`" class="">{{ vendorStore.currentVendor?.bvn }}
                            </div>
                        </div>
                    ...
                    <div v-if="!vendorStore.vendorsLoading">
                        <div v-if="!vendorStore.isEditing" class="tw-flex">
                            ...
                            <div :class="`tw-text-[${$constants.dark}]`" class="">{{
                                vendorStore.currentVendor?.phone_number }}</div>
                        </div>
                ...
                <v-list-item>
                    <div v-if="!vendorStore.vendorsLoading">
                        <div v-if="!vendorStore.isEditing" class="tw-flex">
                            <div :class="`tw-text-[${$constants.primary}]`" class="tw-pr-2"><strong>EMAIL: </strong>
                            </div>
                            <div :class="`tw-text-[${$constants.dark}]`" class="">{{ vendorStore.currentVendor?.email }}
                            </div>
                        </div>
                ...
                <v-list-item>
                    ...
                    <div v-if="!vendorStore.vendorsLoading">
                        ...
                        <text-field label="Address" v-else v-model="vendorStore.currentVendor.address"></text-field>
                    </div>
                    <span v-else><v-skeleton-loader :loading="vendorStore.vendorsLoading" type="text" /></span>
                </v-list-item>
                <v-list-item>
                    <div v-if="!vendorStore.vendorsLoading">
                        <div v-if="!vendorStore.isEditing" class="tw-flex">
                            <div :class="`tw-text-[${$constants.primary}]`" class="tw-pr-2"><strong>CONTACT: </strong>
                            </div>
                            <div :class="`tw-text-[${$constants.dark}]`" class="">{{ vendorStore.currentVendor?.contact
                                }} </div>
                        </div>
                ...
                <v-list-item>
                    <div v-if="!vendorStore.vendorsLoading">
                        <div v-if="!vendorStore.isEditing" class="tw-flex">
                            <div :class="`tw-text-[${$constants.primary}]`" class="tw-pr-2"><strong>ACCOUNT NAME:
                                </strong></div>
                            <div :class="`tw-text-[${$constants.dark}]`" class="">{{
                                vendorStore.currentVendor?.account_name }}</div>
                        </div>
                ...
                <v-list-item>
                    <div v-if="!vendorStore.vendorsLoading">
                        <div v-if="!vendorStore.isEditing" class="tw-flex">
                            <div :class="`tw-text-[${$constants.primary}]`" class="tw-pr-2"><strong>ACCOUNT NUMBER:
                                </strong></div>
                            <div :class="`tw-text-[${$constants.dark}]`" class="">{{
                                vendorStore.currentVendor?.account_number }}</div>
                        </div>
                ...
                <v-list-item>
                    <div v-if="!vendorStore.vendorsLoading">
                        <div v-if="!vendorStore.isEditing" class="tw-flex">
                            <div :class="`tw-text-[${$constants.primary}]`" class="tw-pr-2"><strong>BANK NAME: </strong>
                            </div>
                            <div :class="`tw-text-[${$constants.dark}]`" class="">{{
                                vendorStore.currentVendor?.bank_name }}</div>
                        </div>
                ...
                <v-list-item>
                    <div v-if="!vendorStore.vendorsLoading">
                        <div v-if="!vendorStore.isEditing" class="tw-flex">
                            <div :class="`tw-text-[${$constants.primary}]`" class="tw-pr-2"><strong>STATUS: </strong>
                            </div>
                            <div :class="`tw-text-[${$constants.dark}]`" class="">{{ vendorStore.currentVendor?.status
                                }}</div>
                        </div>
                ...
                <v-list-item v-for="item in items" :key="item.title" class="tw-p-0">
                    <div v-if="!vendorStore.vendorsLoading">
                        <div v-if="!vendorStore.isEditing" class="tw-flex">
                            <div :class="`tw-text-[${$constants.primary}]`" class="tw-pr-2"><strong>{{ item.title }}:
                                </strong></div>
