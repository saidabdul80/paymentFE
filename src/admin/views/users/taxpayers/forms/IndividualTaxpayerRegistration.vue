<template>
    <div>
        ...
        <!--     <v-col cols="12" md="12" sm="12">
                <FileInput lablel="National ID Document" placeholder="NIN slip or national ID card"></FileInput>
            </v-col>
                 -->
            <v-col cols="12" md="12" sm="12">
                    <v-container class="">
                        <v-row align="center" justify="center" class="tw-mt-20">
                            ...
                            <v-col cols="auto">
                                <v-btn @click="$emit('click', true)" v-bind="activatorProps" type="submit" size="large"
