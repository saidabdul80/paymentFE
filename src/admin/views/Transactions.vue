  ...
  data() {
    return {
      ...
      tabs:[
        ...
        { key: "transaction_fee", title: "Trx Fee" },
        { key: "amount", title: "Amount" },
        { key: "transaction_fee", title: "Fee", formatNumber:true  },
        { key: "end_balance", title: "End Balance" },
        { key: "apaylo_balance", title: "Apaylo Bal.", formatNumber:true },
        { key: "system_balance", title: "Sys Bal.", formatNumber:true  },
        { key: "balance_difference", title: "Bal. Diff", formatNumber:true  },
