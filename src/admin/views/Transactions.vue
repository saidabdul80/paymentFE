  ...
  data() {
    return {
      ...
      tabs:[
        ...
        { key: "apaylo_balance", header: "Apaylo Bal.", formatNumber:true },
        { key: "system_balance", header: "Sys Bal.", formatNumber:true  },
        { key: "balance_difference", header: "Bal. Diff", formatNumber:true  },
